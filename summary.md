...
- **An inquiry inbox** on the artisan side lists everything received, marks messages read just by opening the inbox, and now has a genuine "Reply" action: type a message and it's emailed straight to the buyer, who sees the artisan's own words on their own sent-inquiries list, not just a "responded" badge with no content behind it. "Mark as responded" still exists separately for replies that happened over WhatsApp or a phone call instead. A "Reply on WhatsApp" shortcut appears right there when the buyer left a phone number.
